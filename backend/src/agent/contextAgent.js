...
5. WEATHER: Show when it's morning (5–10am), rain/storm/extreme heat/cold, or not shown recently → choose "weather"
6. PORTFOLIO: Interesting portfolio observation (best/worst performer, notable context) → choose "portfolio"
7. MARKET NEWS: News related to user's holdings or watchlist symbols → choose "market_news"
8. GENERAL NEWS: Finance, AI, tech news → choose "general_news"
9. AMBIENT: If nothing specific → choose "ambient"
